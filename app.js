...
let randomProduct3 = products.getRandomProduct();
        ...
        while (randomProduct3 === products.getRandomProduct() || randomProduct3 === randomProduct1) {
            randomProduct3 = products.getRandomProduct();
        }

        img1.src = getRandomProduct1.image;
        img2.src = getRandomProduct2.image;
        img3.src = getRandomProduct3.image;
